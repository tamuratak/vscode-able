...
suite('Playwright Exec Integration Test', () => {
...
<html>
<head><meta charset="utf-8"><title>playwright exec integration</title></head>
<body>
...
`)
        const text = extractText(result)
        ok(text.includes('result:\nplaywright exec integration-ok'))
    })
