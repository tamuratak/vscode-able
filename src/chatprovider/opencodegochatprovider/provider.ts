 ...
 * and HTTP statuses that may succeed on retry (408, 425, 429, 5xx).
 * Non-retryable: user cancellation and client errors (400, 401, 403, ...),
 * which cannot succeed on retry.
 */
function isRetryableError(error: unknown, httpTimedOut: boolean, token: CancellationToken): boolean {
